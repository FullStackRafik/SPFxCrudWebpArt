...
//  import { ICrudProjectWebPartProps } from './ICrudProjectWebPartProps';  
 ...
 private _renderList(items: ISPList[]): void {  
...

  {
   ...
   public render(): void {  
     ...
     <div class="parentContainer" style="background-color: yellow">  
   ...
   x;">Profile Details</div>  
    ...
    <br>  
    <div style="background-color: yellow" id="DivGetItems" />  
